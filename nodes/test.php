<?php
$_POST['username'] = "exam01";
$_POST['password_old'] = "Picnic12";
$_POST['password_new'] = "Picnic13";
...
if (isset($_POST['username'])) {
	...
	try {
		...
		echo "<p><a href=\"index.php?node=reset_password&username=" . $cleanUsername . "\">Click here</a> to try again</p>";
