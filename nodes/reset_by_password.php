...
<form action="#" method="post">
	...
	<div class="mb-3">
		...
		<input type="password" class="form-control form-control-lg" id="password_new" name="password_new" placeholder="New Password" required autocomplete="off" onkeyup="checkFormInput()">
		<input type="password" class="form-control form-control-lg" id="password_confirm" name="password_confirm" placeholder="New Password (confirm)" required  autocomplete="off" onkeyup="checkFormInput()">
	</div>
	<div class="mb-3">
